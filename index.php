...
<head>
    ...
    <script src="https://kit.fontawesome.com/46408efed9.js" crossorigin="anonymous"></script>
    <!-- Google Web Fonts -->
...
?>
                    ...
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <p class="text-white animated slideInLeft mb-4 pb-2">Tempor erat elitr rebum at clita. Diam
                               ...
                               <a class="btn btn-info py-sm-3 px-sm-5" href="booking.php ">Book A Table</a>
                        </div>
            ...
            <div class="container">
                <div class="row g-4">
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                <i class="fa fa-3x fa-utensils text-info mb-4"></i>
                                <h5>Quality Food</h5>
                                <p>Diam elitr kasd sed at elitr sed ipsum justo dolor sed clita amet diam</p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                <i class="fa fa-3x fa-cart-plus text-info mb-4"></i>
                                <h5>Online Order</h5>
                                <p>Diam elitr kasd sed at elitr sed ipsum justo dolor sed clita amet diam</p>
                            </div>
                        </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        <h5 class="section-title ff-secondary text-start text-dark fw-normal">About Us</h5>
                        <h1 class="mb-4">Welcome to <i class="fa fa-utensils text-info me-2"></i>Ocean Bites</h1>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="section-title ff-secondary text-center text-dark fw-normal">Food Menu</h5>
                    ...
                    <ul class="nav nav-pills d-inline-flex justify-content-center border-bottom mb-5">
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 ms-0 pb-3 active" data-bs-toggle="pill"
                                href="#tab-1">
                                <i class="fa fa-coffee fa-2x text-info"></i>
                                <div class="ps-3">
                        ...
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 me-0 pb-3" data-bs-toggle="pill"
                                href="#tab-3">
                                <i class="fa fa-utensils fa-2x text-info"></i>
                                <div class="ps-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="w-100 d-flex flex-column text-start ps-4">
                                                    <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                        <span>Prawn And Haddock Fish Pie</span>
                                                        <button type="submit" value="phfp" name="insert-into-cart"
                                                            style="border: none; background-color: rgb(0, 174, 255);">
                                                            <span class="text-success">$75</span></button>
                                                    </h5>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="w-100 d-flex flex-column text-start ps-4">
                                                <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                    ...
                                                    <button type="submit" value="ss" name="insert-into-cart"
                                                        style="border: none; background-color: rgb(0, 174, 255);">
                                                        <span class="text-success">$50</span></button>
                                                </h5>
                                                <small class="fst-italic">Ipsum ipsum clita erat amet dolor justo
                                ...
                                <div class="col-lg-6">
                                    <form action="addcart.php" method="post">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="w-100 d-flex flex-column text-start ps-4">
                                                <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                    <span>Mediterranean Seafood With Polenta Cubes</span>
                                                    <button type="submit" value="mspc" name="insert-into-cart"
                                                        style="border: none; background-color: rgb(0, 174, 255);">
                                                        <span class="text-success">$120</span></button>
                                                </h5>
                                                <small class="fst-italic">Ipsum ipsum clita erat amet dolor justo
                                                    diam</small>
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <form action="addcart.php" method="post">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="w-100 d-flex flex-column text-start ps-4">
                                                <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                    <span>Grilled Lobster Tails with Garlic Butter</span>
                                                    <button type="submit" value="gltgb" name="insert-into-cart"
                                                        style="border: none; background-color: rgb(0, 174, 255);">
                                                        <span class="text-success">$115</span></button>
                                                </h5>
                                                <small class="fst-italic">Ipsum ipsum clita erat amet dolor justo
                                                    diam</small>
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <form action="addcart.php" method="post">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="w-100 d-flex flex-column text-start ps-4">
                                                <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                    <span>Chipotle Orange Shrimp With Cilantro Rice</span>
                                                    <button type="submit" value="coscr" name="insert-into-cart"
                                                        style="border: none; background-color: rgb(0, 174, 255);">
                                                        <span class="text-success">$80</span></button>
                                                </h5>
                                                <small class="fst-italic">Ipsum ipsum clita erat amet dolor justo
                                                    diam</small>
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <form action="addcart.php" method="post">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="w-100 d-flex flex-column text-start ps-4">
                                                <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                    <span>Spanish Fish Stew</span>
                                                    <button type="submit" value="sfs" name="insert-into-cart"
                                                        style="border: none; background-color: rgb(0, 174, 255);">
                                                        <span class="text-success">$95</span></button>
                                                </h5>
                                                <small class="fst-italic">Ipsum ipsum clita erat amet dolor justo
                                                    diam</small>
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <form action="addcart.php" method="post">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="w-100 d-flex flex-column text-start ps-4">
                                                <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                    <span>Grilled Fish Steak</span>
                                                    <button type="submit" value="gfs" name="insert-into-cart"
                                                        style="border: none; background-color: rgb(0, 174, 255);">
                                                        <span class="text-success">$100</span></button>
                                                </h5>
                                                <small class="fst-italic">Ipsum ipsum clita erat amet dolor justo
                                                    diam</small>
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <form action="addcart.php" method="post">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="w-100 d-flex flex-column text-start ps-4">
                                                <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                    <span>Fish Curry With Nigella Seeds</span>
                                                    <button type="submit" value="fcns" name="insert-into-cart"
                                                        style="border: none; background-color: rgb(0, 174, 255);">
                                                        <span class="text-success">$60</span></button>
                                                </h5>
                                                <small class="fst-italic">Ipsum ipsum clita erat amet dolor justo
                                                    diam</small>
                                            </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item text-center rounded overflow-hidden">
                            ...
                            <h5 class="mb-0">Christopher Adams</h5>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item text-center rounded overflow-hidden">
                            ...
                            <h5 class="mb-0">Ramsey Karlson</h5>
        ...
        <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container">
                <div class="text-center">
                    <h5 class="section-title ff-secondary text-center text-dark fw-normal">Testimonial</h5>
                ...
                <div class="owl-carousel testimonial-carousel">
                    <div class="testimonial-item bg-transparent border rounded p-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <h5 class="mb-1">Angelica Martin</h5>
                    ...
                    <div class="testimonial-item bg-transparent border rounded p-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="img/testimonial-4.jpg"
                                style="width: 50px; height: 50px;">
                            <div class="ps-3">
                                <h5 class="mb-1">Alina Rae</h5>
                                <small>Mechanical Engineer</small>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        function redirectToSection() {
          // Replace 'section2' with the ID of the target section you want to scroll to.
          // You can also use other section IDs like 'section1', 'section3', etc.
          const targetSectionId = 'book_table_section';
