...
if (!isset($_SESSION["user_id"])) {
    ...
    echo '<script>alert("Please log in first to access this page."); window.location.href = "user.php";</script>';
...
if ($run) {
    while ($product = mysqli_fetch_assoc($run)) {
        ...
        <form action='addcart.php' method='post'>
            ...
            <img class='flex-shrink-0 img-fluid rounded' src='images/$ProductPicture' alt='Description of the image' style='width: 80px;'>
                 <div class='w-100 d-flex flex-column text-start ps-4'>
                    <h5 class='d-flex justify-content-between border-bottom pb-2'>
                        <span>$ProductName</span>
                        <span class='text-dark'>$ProductPrice</span>
                        <a href='add_cart_menu.php?productName=$ProductName&product_price=$ProductPrice'>Add to Cart</a>

                        </h5>
                    <small class='fst-italic'>$ProductDesc</small>
                </div>
            </div>
        </form>
        </div>
